...
class Contact:
    ...
    def __init__(self, id=None, firstname=None, lastname=None, address=None, email=None, email2=None, email3=None,
                 all_emails_from_homepage=None, homephone=None, mobilephone=None, workphone=None,
